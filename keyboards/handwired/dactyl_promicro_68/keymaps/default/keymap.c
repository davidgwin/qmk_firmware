...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x6(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,KC_ESC ,KC_DEL,SALEM, KC_ENT,KC_LCTL,       KC_RALT, KC_SPC, SALEM, KC_LEFT,KC_DOWN, KC_UP , KC_RGHT,  KC_RCTL,                                                                       
                                                        MONA ,LEVAN ,       KC_BSPC,  MONA
    ...
    [_LEVAN] = LAYOUT_6x6(
        ...
        X(THORN_L),X(THORN_U),X(GRINF),X(GRINF),X(GFSLGHT),X(BL_BRTG),                          _______,KC_P4  ,KC_P5  ,KC_P6  ,KC_PCMM,_______,
        X(GFWINK),X(HORNS),_______,_______,_______,_______ ,                                    _______,KC_P1  ,KC_P2  ,KC_P3  ,KC_PEQL,_______,

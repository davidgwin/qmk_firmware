...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MONA] = LAYOUT_6x6(
        ...
        _______,_______,_______,_______, MONA  ,_______,                                       KC_WBAK,_______,_______,_______,_______,_______,
    ...
    [_LEVAN] = LAYOUT_6x6(
        ...
        _______,_______,_______, LEVAN,_______,_______,                                       _______,_______,KC_P0  ,KC_DOT ,KC_PENT,_______,
                                                _______,_______,_______,       _______,_______,_______,
                                                                _______,       _______,
                                                                _______,       _______
    ),
